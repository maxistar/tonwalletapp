...
class WalletService {
    ...
    private fun parseNewWalletInfo(walletVersion: Long, configUrl: String?): WalletDetails {
        val result = Wallet.getNewWalletInfo(walletVersion, configUrl)
        val jsonValue = JSONObject(result)
        return WalletDetails(jsonValue.getString("Seed"), jsonValue.getString("Address"))
    }
    ...
    private fun getBalance(seed: String, walletVersion: Long, configUrl: String?): Long {
        ...
        val jsonValue = JSONObject(result)
        return jsonValue.getLong("NanoTons")
    }
    ...
    private fun getTransactions(seed: String, walletVersion: Long, configUrl: String?): WalletHistoryDetails? {
